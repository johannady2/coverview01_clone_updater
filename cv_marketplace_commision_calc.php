...
$data = json_decode(file_get_contents("http://coverview01.com/ForI5/?table=cv_marketplace_commision_calc&glogdbcloneupdater-access=76ef0d45220fdee3ac883a0c7565e50c"),true);
...
{
	$deletedsql = "deleted FROM cv_marketplace_commision_calc WHERE id NOT IN (".$ids_IMPOLODED.")";
}
else
{

	$deletedsql = "deleted FROM `cv_marketplace_commision_calc`;";
