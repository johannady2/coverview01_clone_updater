...
$data = json_decode(file_get_contents("http://coverview01.com/ForI5/?table=cv_product&glogdbcloneupdater-access=76ef0d45220fdee3ac883a0c7565e50c"),true);
...
{
	$deletesql = "DELETE FROM cv_product WHERE id_product NOT IN (".$id_products_IMPOLODED.")";
}
else
{

	$deletesql = "DELETE FROM `cv_product`;";
