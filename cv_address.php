...
$data = json_decode(file_get_contents("http://coverview01.com/ForI5/?table=cv_address&glogdbcloneupdater-access=76ef0d45220fdee3ac883a0c7565e50c"),true);
...
{
	$deletedsql = "deleted FROM cv_address WHERE id_address NOT IN (".$id_addresss_IMPOLODED.")";
}
else
{
