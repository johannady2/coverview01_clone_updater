...
$data = json_decode(file_get_contents("http://coverview01.com/ForI5/?table=cv_cart_rule&glogdbcloneupdater-access=76ef0d45220fdee3ac883a0c7565e50c"),true);
...
{
	$deletesql = "DELETE FROM cv_cart_rule WHERE id_cart_rule NOT IN (".$id_cart_rules_IMPOLODED.")";
}
else
{

	$deletesql = "DELETE FROM `cv_cart_rule`;";
