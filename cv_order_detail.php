...
$data = json_decode(file_get_contents("http://coverview01.com/ForI5/?table=cv_order_detail&glogdbcloneupdater-access=76ef0d45220fdee3ac883a0c7565e50c"),true);
...
{
	$deletesql = "DELETE FROM cv_order_detail WHERE id_order_detail NOT IN (".$id_order_details_IMPOLODED.")";
}
else
{

	$deletesql = "DELETE FROM `cv_order_detail`;";
