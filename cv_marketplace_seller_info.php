...
$data = json_decode(file_get_contents("http://coverview01.com/ForI5/?table=cv_marketplace_seller_info&glogdbcloneupdater-access=76ef0d45220fdee3ac883a0c7565e50c"),true);
...
{
	$deletedsql = "deleted FROM cv_marketplace_seller_info WHERE id NOT IN (".$ids_IMPOLODED.")";
}
else
{

	$deletedsql = "deleted FROM `cv_marketplace_seller_info`;";
