...
$data = json_decode(file_get_contents("http://coverview01.com/ForI5/?table=cv_customer&glogdbcloneupdater-access=76ef0d45220fdee3ac883a0c7565e50c"),true);
...
{
	$deletesql = "DELETE FROM cv_customer WHERE id_customer NOT IN (".$id_customers_IMPOLODED.")";
}
else
{

	$deletesql = "DELETE FROM `cv_customer`;";
